            ...
            >
              ...
              >
                <div
                  ...
                  style={{ padding: "12px" }}
                  className="hover-container short-start"
                  data-title="Pen"
                >
              ...
              >
                <div
                  ...
                  style={{ padding: "12px" }}
                  className="hover-container sticky-margin"
                  data-title="Sticky Notes"
                >
                  <BsStickyFill />
                </div>
              </OverlayTrigger>
              ...
              <div
                ...
                style={{ padding: "12px" }}
                className="hover-container default-margin"
                data-title="Eraser"
              >
